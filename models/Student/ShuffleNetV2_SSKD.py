...
class ShuffleNetV2(nn.Module):
    def __init__(self, net_size, num_classes=10):
        ...
        self.reg_conv1 = nn.Conv2d(out_channels[3], 256, kernel_size=3, padding=1)
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        out = F.relu(self.reg_conv1(out))
        reg_f1 = out
        out = F.relu(self.reg_conv2(out))
        reg_f2 = out
        ...
        if (is_feat):
            return [f0, f1, f2, f3, reg_f1, reg_f2], out, out_normed
