...
#SHHB
# img_path = '../DBs/CC/ProcessedData/Shanghai_B/test/img'
# gt_path = '../DBs/CC/ProcessedData/Shanghai_B/test/label'
# pred_path = './output/density_maps_all_ep_123_mae_5/loc'

#SHHA
# img_path = '../DBs/CC/ProcessedData/Shanghai_A/test/img'
# gt_path = '../DBs/CC/ProcessedData/Shanghai_A/test/label'
# pred_path = './output/density_maps_all_ep_673_mae_81/loc'

#QNRF
img_path = '../DBs/CC/ProcessedData/JHU_CROWD/test/img'
gt_path = '../DBs/CC/ProcessedData/JHU_CROWD/test/label'
pred_path = './output/density_maps_all_ep_13_mae_d_77/loc'
